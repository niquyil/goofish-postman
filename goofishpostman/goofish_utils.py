...
# 14 平台提示条、25 平台消息卡（评价提醒/开箱视频提醒/送小红花，都是运营提醒）
SILENT_CONTENT_TYPES = frozenset({14, 25})
...
def is_silent_message(payload: dict) -> bool:
    ...
    - 14 平台提示条（"想要卖家更快回复？平台帮你催促"之类）与 25 平台消息卡
      （评价提醒 / 开箱视频提醒 / 送小红花），都是平台运营提醒：
      真实历史 248 条里 14 有 43 条、25 有 20 条，属于噪音；
    - 26 交易卡片里只放行 KEPT_TRADE_CARD_TITLES 那几种文案。

    这些都只在飞书侧静音，网页消息流仍然记录，随时能回查。
